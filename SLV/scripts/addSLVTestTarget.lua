...
function usage()
  print("Usage: ./lua addSLVTestTarget.lua <platform label> <root filesystem version> <target> <(optional) platform only>");
end
...
function copyPlatform(rfs, srcPlatform, srcOnly)
  ...
  if srcOnly == false then
    ...
    os.execute("rsync -rl --exclude=.svn /home/sgp1000/EGMPlatforms/A2NWX01A/branches/" .. srcPlatform .. "/ /home/sgp1000/build");
  else
    print(" -- Platform is clean");
    os.execute("mkdir /home/sgp1000/build/images/platform/P5/" .. stripVersion(srcPlatform));
    os.execute("rsync -rl --exclude=.svn /home/sgp1000/EGMPlatforms/A2NWX01A/branches/" .. srcPlatform .. "/ /home/sgp1000/build/images/platform/P5/" .. stripVersion(srcPlatform));
  end
end
