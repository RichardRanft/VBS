...
function north_america.createDocPacket(buildVersion, sourceFolder, gameName, partNum, platform)
  ...
  north_america.PC4SigsName = north_america.Version .. "_" .. north_america.Platform .. "_pc4.sigs";
...
function north_america.setupSourceFolders()
  ...
  if file_exists(north_america.Source) ~= true then
  ...
  if file_exists(north_america.docSrcCalcs) ~= true then
    north_america.docSrcCalcs = north_america.docRoot .. "Calcs";
    if file_exists(north_america.docSrcCalcs) ~= true then
  ...
  if file_exists(north_america.docSrcMisc) ~= true then
    north_america.docSrcMisc = north_america.docRoot .. "Misc";
    if file_exists(north_america.docSrcMisc) ~= true then
  ...
  if file_exists(north_america.docSrcSpecs) ~= true then
    north_america.docSrcSpecs = north_america.docRoot .. "Specs";
    if file_exists(north_america.docSrcSpecs) ~= true then
  ...
  if file_exists(north_america.docSrcPars) ~= true then
    north_america.docSrcPars = north_america.docRoot .. "Pars";
    if file_exists(north_america.docSrcPars) ~= true then
  ...
  if file_exists(north_america.helpScreenFolder) ~= true then
  ...
  if file_exists(north_america.topboxFolder) ~= true then
    -- in case the help/english folder is not there
...
function north_america.copySigs()
  ...
  os.execute(cmd);
  cmd = "cp " .. north_america.GameRoot .. "/pc4hmac.bin " .. north_america.targetDir .. "/" .. north_america.Version .. "_pc4hmac.bin";
  os.execute(cmd);
  cmd = "cp " .. north_america.GameRoot .. "/sha1.bin " .. north_america.targetDir .. "/" .. north_america.Version .. "_sha1.bin";
  os.execute(cmd);
  cmd = "cp " .. north_america.GameRoot .. "/table.bin " .. north_america.targetDir .. "/" .. north_america.Version .. "_table.bin";
  os.execute(cmd);
  print(" -- Copy complete.");
end
