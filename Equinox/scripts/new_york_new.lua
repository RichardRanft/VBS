...
function new_york.cleanString(dirtyString)
    valid = true;
    if dirtyString == nil then
        print(" --- cleanString : dirtyString is invalid");
        valid = false;
    end
    if valid == false then
        return;
    end
    new = string.gsub(dirtyString, "()//()", "/");
    return new;
end

function new_york.getGameImage()
    imageSrcPath = new_york.cleanString("/home/sgp1000/ReleaseImages/" .. new_york.Version .. ".img.gz");
    
    imageDestPath = new_york.cleanString(new_york.targetDir .. "/Software/\"Game Image/" .. new_york.Version .. ".img.gz\"");
...
function new_york.packCurrentRevision(Version)
  ...
  prepCmd = new_york.cleanString("sudo cp " .. workingFolder .. "/*.gz ../*");
  os.execute(prepCmd);
  clearCmd = new_york.cleanString("sudo rm " .. workingFolder .. "/*.gz");
  os.execute(clearCmd);
  tarCmd = new_york.cleanString("sudo tar cvzf \"".. workingFolder .. "../" .. Version .. "_source.tar.gz\" " .. workingFolder .. "/*");
  os.execute(tarCmd);
  restoreCmd = new_york.cleanString("sudo cp " .. workingFolder .. "../*.gz " .. workingFolder);
...
function new_york.createTargetTree()
  ...
  new_york.targetDocRoot = new_york.cleanString(new_york.targetDir .. "/Documentation/");
  ...
  new_york.targetSoftwareFolder = new_york.cleanString(new_york.targetDir .. "/Software/");
  os.execute("mkdir " .. new_york.targetSoftwareFolder);

  -- set up target game image folder
  new_york.targetImageFolder = new_york.cleanString(new_york.targetSoftwareFolder .. "\"/Game Image/\"");
  os.execute("mkdir " .. new_york.targetImageFolder);

  -- set up target game labels folder
  new_york.targetLabelsFolder = new_york.cleanString(new_york.targetSoftwareFolder .. "\"/Game Labels/\"");
  os.execute("mkdir " .. new_york.targetLabelsFolder);
  
  -- set up target game source folder
  new_york.targetSourceFolder = new_york.cleanString(new_york.targetSoftwareFolder .. "\"/Game Source Code/\"");
  os.execute("mkdir " .. new_york.targetSourceFolder);
  
  -- set up target game video folder
  new_york.targetVideoFolder = new_york.cleanString(new_york.targetSoftwareFolder .. "\"/Game Video/\"");
  os.execute("mkdir " .. new_york.targetVideoFolder);
  
  -- set up target game XADF folder
  new_york.targetXADFFolder = new_york.cleanString(new_york.targetSoftwareFolder .. "\"/XADF & BIN Files/\"");
  os.execute("mkdir " .. new_york.targetXADFFolder);
  
  -- set up target game XLDF folder
  new_york.targetXLDFFolder = new_york.cleanString(new_york.targetSoftwareFolder .. "\"/XLDF Files/\"");
...
function new_york.createPacketTreeBase()
  ...
  new_york.targetDir = new_york.cleanString("\"/home/sgp1000/Release/EGM/PC4/NewYork/" .. new_york.Name .. " " .. new_york.Version .. " " .. new_york.PartNum .. "/\"");
...
function new_york.setupSourceFolders()
  ...
  new_york.docSrcCalcs = new_york.cleanString(new_york.docRoot .. "calcs");
  ...
  new_york.docSrcMisc = new_york.cleanString(new_york.docRoot .. "misc");
  ...
  -- set up source specs folder
  new_york.docSrcSpecs = new_york.cleanString(new_york.docRoot .. "specs");
  ...
  new_york.helpScreenFolder = new_york.cleanString(new_york.Source .. "/resource_widescreen/help/english");
  if file_exists(new_york.helpScreenFolder) ~= true then
    -- in case the help/english folder is not there
    new_york.helpScreenFolder = new_york.cleanString(new_york.Source .. "/resource_widescreen/help");
    if file_exists(new_york.helpScreenFolder) ~= true then
  ...
  -- topbox images
  new_york.topboxFolder = new_york.cleanString(new_york.Source .. "/topbox/resource/");
  if file_exists(new_york.topboxFolder) ~= true then
    -- in case the help/english folder is not there
    new_york.topboxFolder = new_york.cleanString(new_york.Source .. "/topbox_widescreen/resource/");
    if file_exists(new_york.topboxFolder) ~= true then
  ...
  -- xldf files
  new_york.xldfFolder = new_york.cleanString(new_york.Source .. "/xldf/");
  ...
  -- set up source game images root folder
  new_york.gameImgRoot = new_york.cleanString(new_york.imgRoot .. "games/" .. new_york.Version .. "/" .. new_york.Version .. ".img.gz");
...
function new_york.copySigs()
  ...
  cmd = new_york.cleanString("cp " .. new_york.GameRoot .. "/" .. new_york.Version .. ".sigs " .. new_york.targetXADFFolder .. "/" .. new_york.Version .. ".sigs");
  os.execute(cmd);
  cmd = new_york.cleanString("cp " .. new_york.GameRoot .. "/diskend.sigs " .. new_york.targetXADFFolder .. "/" .. new_york.Version .. "_diskend.sigs");
  os.execute(cmd);
  cmd = new_york.cleanString("cp " .. new_york.GameRoot .. "/pc4.sigs " .. new_york.targetXADFFolder .. "/" .. new_york.PC4SigsName);
  os.execute(cmd);
  cmd = new_york.cleanString("cp " .. new_york.GameRoot .. "/pc4hmac.bin " .. new_york.targetXADFFolder .. "/" .. new_york.Version .. "_pc4hmac.bin");
  os.execute(cmd);
  cmd = new_york.cleanString("cp " .. new_york.GameRoot .. "/sha1.bin " .. new_york.targetXADFFolder .. "/" .. new_york.Version .. "_sha1.bin");
  os.execute(cmd);
  cmd = new_york.cleanString("cp " .. new_york.GameRoot .. "/table.bin " .. new_york.targetXADFFolder .. "/" .. new_york.Version .. "_table.bin");
  os.execute(cmd);
  print(" -- Copy complete.");
end
...
function new_york.zipXLDF()
  ...
  targetFile = new_york.cleanString(new_york.targetXLDFFolder .. "/" .. new_york.Version .. "_XLDF.tar.gz");
  print(" -- Begin zipping XLDF files to:");
  print(" --- " .. targetFile);
  -- run gzip on sourceDir
  tarCmd = new_york.cleanString("cd " .. new_york.Source .. "; sudo tar --format=gnu -czf " .. targetFile .. " xldf/*");
...
function new_york.zipSource()
  ...
  targetFile = new_york.cleanString(new_york.targetSourceFolder .. new_york.Version .. "_source.tar.gz");
  print(" -- Begin zipping source to:");
  print(" --- " .. targetFile);
  -- run gzip on sourceDir
  tarCmd = new_york.cleanString("cd /home/sgp1000/build/images/games/; sudo tar --format=gnu -czf " .. targetFile .. " " .. new_york.Version);
  --sprintf(tarCmd, "sudo tar cvzf \"%s%s_source.tar.gz\" /home/sgp1000/build/images/games/%s/*", &targetDir, &build, &build);
  os.execute(tarCmd);
...
function new_york.createInfoFile(fileName)
  ...
  cmd = new_york.cleanString("cp /dev/null " .. fileName);
  os.execute(cmd);
