...
function latin_america.copySigs()
  print(" -- Copying .bin and .sigs files....");
  cmd = "cp " .. latin_america.GameRoot .. "/" .. latin_america.Version .. ".sigs " .. latin_america.targetDir .. "/" .. latin_america.Version .. ".sigs";
  os.execute(cmd);
  cmd = "cp " .. latin_america.GameRoot .. "/diskend.sigs " .. latin_america.targetDir .. "/" .. latin_america.Version .. "_diskend.sigs";
  os.execute(cmd);
  cmd = "cp " .. latin_america.GameRoot .. "/pc4.sigs " .. latin_america.targetDir .. "/" .. latin_america.PC4SigsName;
  os.execute(cmd);
  cmd = "cp " .. latin_america.GameRoot .. "/pc4hmac.bin " .. latin_america.targetDir .. "/" .. latin_america.Version .. "_pc4hmac.bin";
  os.execute(cmd);
  cmd = "cp " .. latin_america.GameRoot .. "/sha1.bin " .. latin_america.targetDir .. "/" .. latin_america.Version .. "_sha1.bin";
  os.execute(cmd);
  cmd = "cp " .. latin_america.GameRoot .. "/table.bin " .. latin_america.targetDir .. "/" .. latin_america.Version .. "_table.bin";
  os.execute(cmd);
  print(" -- Copy complete.");
end

function latin_america.zipSource()
  latin_america.copySigs();
